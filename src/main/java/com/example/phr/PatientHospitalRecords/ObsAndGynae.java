...
@Entity(name = "obstetrics_gynaecology")
public class ObsAndGynae extends General {
    public static final String O_G_CONSULT_CODE = "CONSULT FOR OBSTETRICS AND GYNAECOLOGY";
...
//    private Emergency o_gConsult;

    public ObsAndGynae(String consult) {
        this.consult = consult;
    }

//    public Emergency getO_gConsult() {
//        return o_gConsult;
//    }

//    public void setO_gConsult(Emergency o_gConsult) {
//        this.o_gConsult = o_gConsult;
//    }
    ...
    public ObsAndGynae(String presenting_complaint, String history_of_presenting_complaint, String past_medical_history,
                       String past_surgical_history, String clinical_examination, String provisional_diagnosis,
                       String investigations, String treatment, String consult) {
