package com.example.phr.PatientHospitalRecords.entity.surgery;
...
public class Surgery extends General {
    public static final String SURGERY_CONSULT_CODE = "CONSULT FOR SURGERY";
...
//    private Emergency surgeryConsult;

//    public Surgery(Emergency surgeryConsult) {
//        this.surgeryConsult = surgeryConsult;
//    }

//    public Emergency getSurgeryConsult() {
//        return surgeryConsult;
//    }

//    public void setSurgeryConsult(Emergency surgeryConsult) {
//        this.surgeryConsult = surgeryConsult;
//    }

    public Surgery() {
    }
    public Surgery(String consult) {
    ...
    public Surgery(String first_name, String last_name, int age, String sex, String religion, String occupation,
